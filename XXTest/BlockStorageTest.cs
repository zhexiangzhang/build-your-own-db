    ...
    public class BlockStorageTest
    {
        ...
        public void TestBlockStoragePersistent()
        {
            using (var ms = new MemoryStream())
            {
                ...
                using (var thirdBlock = storage.CreateNew())
                {
                    ...
                    Assert.AreEqual(storage.getBlockSize() * 3, ms.Length);
                }
        ...
        public void Test8KBlock()
        {
            using (var ms = new MemoryStream())
            {
                ...
                var ex0 = new byte[blockStorage.getBlockDataSize()];
                ...
                using (var e = blockStorage.CreateNew())
                {
                    ...
                    // Assert
                    var t0 = new byte[blockStorage.getBlockDataSize()];
        ...
        //        var blockStart = storage.getBlockSize() * 22;
        ...
        //        var firstSector = new byte[storage.getDiskSectorSize()];
        //        ms.Position = ms.Position - 4 * 8;
        //        ms.Read(firstSector);
        //        using (var block = new Block(storage, 22, ms, firstSector))
        //        {
        //            block.GetHeader(0);
        ...
        //       var storage = new BlockStorage(new MemoryStream());
        //       var firstSector = new byte[storage.getDiskSectorSize()];
        //        ms.Position = storage.getBlockSize() * 3;
        //        ms.Read(firstSector);
        //        using (var block = new Block(storage, 3, ms, firstSector))
        //        {
        ...
        //            Assert.Throws<ArgumentOutOfRangeException>(delegate
        //            {
        //                block.Write(new byte[32], 0, storage.getBlockDataSize() - 31, 32);
        //            });

        //            Assert.DoesNotThrow(delegate
        //            {
        //                block.Write(new byte[32], 0, storage.getBlockDataSize() - 32, 32);
        //            });
        //        }
        //    }
        //}
        ...
        //        Generate a stream
        //       var storage = new BlockStorage(new MemoryStream());
        //        var blockStart = storage.getBlockSize() * 3;
        ...
        //        ms.Position = storage.getBlockSize() * 3 + storage.getBlockHeaderSize();
        ...
        //            block.Read(result
        //                , 64
        //                , storage.getDiskSectorSize() - storage.getBlockHeaderSize()
        //                , 1024 - 64);
        ...
        //            Assert.Throws<ArgumentOutOfRangeException>(delegate
        //            {
        //                block.Read(new byte[12 * 1024], 0, 0, storage.getBlockDataSize());
        //            });
        //        }
        //    }
        //}
